...
<html lang="en">
			...
			<div class="container">
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						...
						<li><a href="{{ route('index.cursos')}}">Cursos</a></li>
	...
	<script type="text/javascript" src="{{ url('template/js/google-map.js') }}"></script>
	<script type="text/javascript" src="{{ url('template/js/main.js') }}"></script>
